...
#define HOST_LINK_VERSION "241.6"

/* Installation directory for binary executables */
#define LLVM_BINDIR "/usr/local/clang/bin"

/* Time at which LLVM was configured */
#define LLVM_CONFIGTIME "Sun Aug 31 23:16:40 PDT 2014"

/* Installation directory for data files */
#define LLVM_DATADIR "/usr/local/clang/share/llvm"

/* Target triple LLVM will generate code for by default */
#define LLVM_DEFAULT_TARGET_TRIPLE "x86_64-apple-darwin14.0.0"

/* Installation directory for documentation */
#define LLVM_DOCSDIR "/usr/local/clang/share/doc/llvm"
...
#define LLVM_ETCDIR "/usr/local/clang/etc/llvm"
...
#define LLVM_INCLUDEDIR "/usr/local/clang/include"

/* Installation directory for .info files */
#define LLVM_INFODIR "/usr/local/clang/info"

/* Installation directory for man pages */
#define LLVM_MANDIR "/usr/local/clang/man"
...
#define LLVM_PREFIX "/usr/local/clang"
